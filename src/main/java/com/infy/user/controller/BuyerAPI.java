...
public class BuyerAPI {
	...
	@PutMapping(value = "/reward/{buyerId}/{rewPoints}")
	public ResponseEntity<String> updateRewardPoints(@PathVariable String buyerId, @PathVariable Float rewPoints)
	{
		
			String msg;
			try {
				msg = userService.updateRewardPoint(buyerId, rewPoints);
