...
//		System.out.println(buyer);
	...
	public SellerDTO getSeller(String id) throws UserMsException {
		...
		return sellerRepository.findById(id).orElseThrow(()-> new UserMsException("Seller Not found")).toDTO();
	}
	...
	public String deactiveSeller(String id) throws UserMsException {
		...
		Seller seller = sellerRepository.findById(id).orElseThrow(()-> new UserMsException("Seller Not found"));
	...
	@Override
	public List<WishlistDTO> getWishlist(String buyerId) throws UserMsException {

		Iterable<Wishlist> wishlist = wishlistRepository.findByCustomIdBuyerId(buyerId);
	...
	public List<CartDTO> getCartProducts(String id) throws UserMsException {
		...
		if (cartItem.isEmpty())
			throw new UserMsException("No Items In Cart", HttpStatus.NOT_FOUND.value());
	...
	public String removeFromCart(String buyerId, String prodId) throws UserMsException {
		...
		if (cart == null)
			throw new UserMsException("No Such Item In Cart", HttpStatus.NOT_FOUND.value());
